...
public class AddServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	  ...
	  boolean f=   housenews.addHouse(userName , houseTitle, houseType, area, bedNumber, price, housePictures, dateOfHouseCard, locations, contact, detailedMessage, bath, carBarn);
		if(f) {
