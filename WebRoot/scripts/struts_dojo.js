...
dojo.io.cookie.getObjectCookie = function(name) {
	var _2eb = null,
		_2ec = dojo.io.cookie.getCookie(name);
	if (_2ec) {
		_2eb = {};
		var _2ed = _2ec.split("&");
...
dojo.ns = {
	...
	loading : {},
	loaded : {},
	register : function(name, _635, _636, _637) {
...
dojo.widget._parser_collection = {
	"dojo" : new dojo.widget.Parse()
};
...
dojo.lfx.toggle.explode = {
	show : function(node, _819, _81a, _81b, _81c) {
		dojo.lfx.explode(_81c || {
				x : 0,
				y : 0,
				width : 0,
				height : 0
			}, node, _819, _81a, _81b).play();
	},
	hide : function(node, _81e, _81f, _820, _821) {
		dojo.lfx.implode(node, _821 || {
				x : 0,
				y : 0,
				width : 0,
				height : 0
...
dojo.declare("dojo.widget.HtmlWidget", dojo.widget.DomWidget, {
	...
	resizeTo : function(w, h) {
		dojo.html.setMarginBox(this.domNode, {
			width : w,
			height : h
		});
		if (this.isShowing()) {
...
dojo.widget.defineWidget("dojo.widget.RichText", dojo.widget.HtmlWidget, function() {
	...
	onKeyPress : function(e) {
		...
		if (this._keyHandlers[e.key]) {
			var _8db = this._keyHandlers[e.key],
				i = 0,
				_8dd;
			while (_8dd = _8db[i++]) {
...
dojo.kwCompoundRequire({
	common : [ "dojo.lang.common", "dojo.lang.assert", "dojo.lang.array", "dojo.lang.type", "dojo.lang.func", "dojo.lang.extras", "dojo.lang.repr", "dojo.lang.declare" ]
});
...
dojo.declare("dojo.dnd.DragManager", null, {
	...
	dragObjects : [],
	dragSources : [],
	registerDragSource : function(_a77) {},
	dropTargets : [],
	registerDropTarget : function(_a78) {},
	lastDragTarget : null,
...
dojo.declare("dojo.dnd.HtmlDragObject", dojo.dnd.DragObject, {
	...
	onDragStart : function(e) {
		...
		dojo.event.topic.publish("dragStart", {
			source : this
		});
	},
	getConstraints : function() {
		...
		return {
			minX : x,
			minY : y,
			maxX : x + _ac6 - mb.width,
			maxY : y + _ac7 - mb.height
		};
	},
	...
	onDragMove : function(e) {
		...
		dojo.event.topic.publish("dragMove", {
			source : this
		});
	},
...
dojo.widget.defineWidget("dojo.widget.ResizeHandle", dojo.widget.HtmlWidget, {
	...
	_changeSizing : function(e) {
		...
		if (this.targetWidget) {
			...
			dojo.html.setMarginBox(this.targetDomNode, {
				width : newW,
				height : newH
			});
		}
		...
		if (this.titleBarDisplay) {
			...
			dojo.event.topic.subscribe("dragMove", function(info) {
				if (info.source.domNode == self.domNode) {
					dojo.event.topic.publish("floatingPaneMove", {
						source : self
					});
				}
			});
...
dojo.widget.html.stabile._getStorage = function() {
	...
	return dojo.widget.html.stabile.dataField = form ? form.stabile : {
		value : ""
	};
};
...
dojo.declare("dojo.widget.incrementalComboBoxDataProvider", null, function(_c0d) {
	...
	startSearch : function(_c10, _c11) {
		...
		var _c13 = dojo.string.substituteParams(this.searchUrl, {
			"searchString" : tss
		});
		var _c14 = this;
...
dojo.widget.defineWidget("dojo.widget.TreeSelector", dojo.widget.HtmlWidget, function() {
	...
	destroy : function() {
		dojo.event.topic.publish(this.eventNames.destroy, {
			source : this
		});
	...
	select : function(_e77) {
		...
		this.doSelect(node);
		dojo.event.topic.publish(this.eventNames.select, {
			node : node
		});
	},
	...
	deselect : function() {
		...
		node.unMarkSelected();
		dojo.event.topic.publish(this.eventNames.deselect, {
			node : node
		});
	}
});
...
dojo.widget.defineWidget("struts.widget.StrutsTreeSelector", dojo.widget.TreeSelector, {
	...
	select : function(_e84) {
		...
		this.doSelect(node);
		this.publishTopics(this.selectedNotifyTopicsArray, {
			node : node
		});
	},
	expand : function(_e87) {
		var node = _e87.source;
		this.publishTopics(this.expandedNotifyTopicsArray, {
			node : node
		});
	},
	collapse : function(_e89) {
		var node = _e89.source;
		this.publishTopics(this.collapsedNotifyTopicsArray, {
			node : node
		});
	}
});
...
dojo.widget.defineWidget("dojo.widget.PageController", dojo.widget.HtmlWidget, {
	...
	onAddChild : function(page) {
		var _ea1 = dojo.widget.createWidget(this.buttonWidget, {
			label : page.label,
...
dojo.widget.defineWidget("dojo.widget.TreeNode", dojo.widget.HtmlWidget, function() {
	...
	expand : function() {
		...
		dojo.event.topic.publish(this.tree.eventNames.expand, {
			source : this
		});
	},
	collapse : function() {
		...
		this.updateExpandIcon();
		dojo.event.topic.publish(this.tree.eventNames.collapse, {
			source : this
		});
	},
...
dojo.json = {
	...
	register : function(name, _ef0, wrap, _ef2) {
...
dojo.widget.defineWidget("dojo.widget.Tree", dojo.widget.HtmlWidget, function() {
	...
	createDOMNode : function() {
		...
		dojo.event.topic.publish(this.eventNames.treeCreate, {
			source : this
		});
	},
	destroy : function() {
	...
	addChild : function(_f86, _f87) {
		var _f88 = {
			...
			index : _f87,
			parent : this,
			domNodeInitialized : _f86.domNodeInitialized
		};
...
dojo.kwCompoundRequire({
	common : [ "struts.widget.Bind", "struts.widget.BindDiv", "struts.widget.BindAnchor", "struts.widget.ComboBox", "struts.widget.StrutsTimePicker", "struts.widget.StrutsDatePicker", "struts.widget.BindEvent", "struts.widget.StrutsTreeSelector", "struts.widget.StrutsTabContainer", "struts.widget.StrutsTreeNode", "struts.widget.StrutsTree" ]
});
