...
<html lang="en">
	...
	<body class="listing-template">
		...
		<div id="site-banner" class="text-center clearfix">
			<div class="container">
				<h1 class="title wow slideInLeft">Properties Grid</h1>
				<ol class="breadcrumb wow slideInRight">
					<li>
						<a href="index.html">Home</a>
					</li>
					<li>
						<a href="property-map-view.html">Listing</a>
					</li>
		...
		<section id="property-listing">
			...
			<div class="container section-layout">
				...
				<!--房屋信息  做循环-->
					<c:forEach items="${sessionScope.list }" var="dd">
						...
						<article class="property layout-item clearfix">
							...
							<div class="property-contents clearfix">
								<header class="property-header clearfix">
									<div class="pull-left">
										<h6 class="entry-title"><a href="single-property.jsp">${dd.houseTitle }<</a></h6>
										<span class="property-location"><i class="fa fa-map-marker"></i>${dd.location}</span>
									</div>
									<button class="btn btn-default btn-price pull-right btn-3d" data-hover="$389.000"><strong>${dd.price }</strong></button>
								</header>
								<div class="property-meta clearfix">
									<span><i class="fa fa-arrows-alt"></i> ${dd.area }</span>
									<span><i class="fa fa-bed"></i> ${dd.bedNumber }</span>
									<span><i class="fa fa-bathtub"></i>${dd.bath }</span>
									<span><i class="fa fa-cab"></i> ${dd.carBarn }</span>
								</div>
